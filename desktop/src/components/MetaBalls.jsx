...
// Функция для парсинга HEX-цветов
...
const MetaBalls = ({
  ...
  useEffect(() => {
    ...
    function onPointerMove(e) {
      ...
      const marginY = rect.height * 0.07;

      // Проверка, находится ли курсор в допустимой области
      if (
          px < marginX ||
          px > rect.width - marginX ||
          py < marginY ||
          py > rect.height - marginY
      ) {
        pointerInside = false; // Курсор вне допустимой области
        return;
      }

      pointerInside = true; // Курсор внутри допустимой области
    ...
    function update(t) {
      ...
      // Обновление позиции шарика под курсором
      let targetX, targetY;
      if (pointerInside) {
        targetX = pointerX;
        targetY = pointerY;
